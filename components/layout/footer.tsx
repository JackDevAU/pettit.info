	...
	return (
      ...
      <div className="flex flex-wrap justify-center sm:justify-between items-center gap-8 sm:gap-12 px-8 mb-12 opacity-80 grayscale hover:grayscale-0 transition-all duration-500">
        <div className="relative h-12 w-32">
           <Image src="/ssw-logo.png" alt="SSW" fill sizes="128px" className="object-contain" />
        </div>
        <div className="relative h-12 w-32">
           <Image src="/Westpac_logo.svg.png" alt="Westpac" fill sizes="128px" className="object-contain" />
        </div>
        <div className="relative h-12 w-32">
           <Image src="/IPWEA_national_cmyk_Australasia.png" alt="IPWEA" fill sizes="128px" className="object-contain" />
        </div>
        <div className="relative h-12 w-32">
           <Image src="/Rapiscan_logo_545x194.png" alt="Rapiscan" fill sizes="128px" className="object-contain" />
        </div>
        {/* Increased size for Hitachi logo */}
        <div className="relative h-20 w-44">
           <Image src="/hitachi.svg" alt="Hitachi" fill sizes="176px" className="object-contain" />
        </div>
      </div>
