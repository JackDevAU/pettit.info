---
title: >-
  Why Pay $150? Here’s How to Add Password Protection to Your Vercel App for
  Free
description: >-
...
This file defines your NextAuth configuration, enabling a credentials-based authentication flow. Create a file called auth.ts in your project (e.g., in the src directory) and add the following code:
...
Locally we can test this by setting your password in a .env file in your project root:
